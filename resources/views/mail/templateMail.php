<style type="text/css">
   ...
   img {outline:none; text-decoration:none;border:none; -ms-interpolation-mode: bicubic; object-fit: cover}
   a img {border:none;}
                                 ...
                                 <td width="140" height="50" align="center">
                                    <div class="imgpop">
                                       <a target="_blank" href="#">
                                          <img src="{!! url('/images/no_uploaded.png') !!}" alt="" border="0" width="140" height="50" style="display:block; border:none; outline:none; text-decoration:none;" class="lfm">
                  ...
                  <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                     ...
                     <tr>
                        ...
                        <td align="center" st-image="banner-image">
                           <div class="imgpop">
                              <a target="_blank" href="#"><img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="lfm" src="{!! url('/images/no_uploaded.png') !!}" class="banner"></a>
                           </div>
                        </td>
                     </tr>
                     </tbody>
                           ...
                           <table width="280" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                              ...
                              <tr>
                                 <td width="280" height="140" align="center" class="devicewidth">
                                    <img src="{!! url('/images/no_uploaded.png') !!}" alt="" border="0" width="280" height="140" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img lfm">
                                    <input type="hidden" name="image[]" value="">
                                 </td>
                              </tr>
                              <!-- /image -->
                                    ...
                                    <table width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                       ...
                                       <tr>
                                          <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #282828; text-align:left; line-height: 24px;">
                                             ...
                                             <input type="text" name="title[]" value="Your Heading Goes Here">
                                          </td>
                                       </tr>
                                       <!-- end of title -->
                                       <!-- Spacing -->
                                       ...
                                       <tr>
                                          <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:left; line-height: 24px;">
                                                                        <textarea name="description[]"  id="description1" cols="33" rows="4">
                                             ...
                                             <table width="120" height="32" bgcolor="#eacb3c" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
                                                ...
                                                <tr>
                                                   <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                                      <a style="text-decoration: none;color: #282828; text-align:center;" href="#">Learn More</a>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td height="9" align="center" style="font-size:1px; line-height:1px;">&nbsp;</td>
                           ...
                           <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                              ...
                              <tr>
                                 <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #282828; text-align:center; line-height: 24px;">
                                    ...
                                    <input type="hidden" name="title[]" value="Full Width Text block content">
                                 </td>
                              </tr>
                              <!-- End of Title -->
                              <!-- spacing -->
                              ...
                              <tr>
                                 <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;">
                                                            <textarea id="description2" style="width: 100%"  name="" id="" cols="30" rows="10">
                           ...
                           <table  width="150" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                              ...
                              <tr>
                                 <td width="43" height="43" align="center">
                                    <div class="imgpop">
                                       <a target="_blank" href="#">
                                          <img src="{!! url('/images/no_uploaded.png') !!}" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" class="lfm">
                                          <input type="hidden" name="image[]" value="">
                                       </a>
                                    </div>
                                 </td>
